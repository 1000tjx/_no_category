...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     html
     react
     (tern :variables tern-command '("node" "/opt/node/bin/tern"))
